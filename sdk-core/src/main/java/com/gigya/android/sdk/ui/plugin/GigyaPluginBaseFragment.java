...
public class GigyaPluginBaseFragment<A extends GigyaAccount> extends Fragment implements IGigyaPluginFragment<A>, HostActivity.OnBackPressListener {

    private static final String LOG_TAG = "GigyaPluginBaseFragment";
